...
const Home = () => {
  return (
    <div className="  w-full h-screen flex flex-col lg:flex-row justify-center items-center mr-10 bg-[#0a192f] gap-4">
      {/* Container */}
      <div className=" ">
      ...
      <div className="">
        <img
      src={Avatar}
       className="object-cover rounded-full duration-300 w-[200px] h-[200px] hover:shadow-2xl hover:shadow-white "
        alt="Thai Duy"
      />
