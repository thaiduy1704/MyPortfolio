...
const About = () => {
  return (
    ...
    <div id="about" className=" w-full h-screen bg-[#0a192f] mx-auto ">
      <div className="container mx-auto my-auto">
        <div className="text-center pt-[10rem] ">
          <p className="text-4xl mt-12 text-gray-300 font-bold border-b-4 border-pink-600 inline">
            About
          </p>
        </div>
        <div className=' w-full grid gird-cols-1 md:grid-cols-2  px-2 mt-5 gap-5'>
          ...
          <motion.div
            ...
            transition={{ delay: 1 }}
            className="a-left md:ml-[2rem] ml-[-9rem]"
          >
          ...
          <div className="content_about mt-[100px] pb-[10rem]">
            <p className="text-2xl md:text-3xl  text-gray-300  md:border-l-2 md:border-pink-400 font-sans">
