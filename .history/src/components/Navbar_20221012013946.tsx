  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
      ...
      <ul className="hidden md:flex">
        <li className="hover:bg-pink-600 hover:border-pink-600 p-4 hover:font-bold duration-8000">
          Home
        </li>
        <li className="hover:bg-pink-600 hover:border-pink-600 p-4">About</li>
        <li className="hover:bg-pink-600 hover:border-pink-600 p-4">Skills</li>
        <li className="hover:bg-pink-600 hover:border-pink-600 p-4">Contact</li>
        <li className="hover:bg-pink-600 hover:border-pink-600 p-4">
          Download CV
        </li>
      </ul>
