  ...
  return (
    <div className="w-full h-screen bg-[#0a192f] text-gray-300 ">
      ...
      <div className="max-w-[1000px] flex flex-col mx-auto">
        ...
        <div className=" grid grid-cols-2 sm:grid-cols-4 gap-1 w-[60%] mx-auto items-center absolute">
          <div className="cursor-pointer logo_skills " style={{ zIndex: 0 }}>
            <img className="w-20 mx-auto" src={HTML} alt="" />
            <p className="text-center">HTML</p>
          </div>
          <div className="cursor-pointer  w-[50px] h-[50px] hover:w-[100px] hover:h-[100px]">
            <img className="w-20 mx-auto" src={CSS} alt="" />
            <p className="text-center">CSS</p>
          </div>
          <div className="cursor-pointer logo_skills">
