...
const Home = () => {
  return (
    <div className=" bg-[#0a192f] w-full h-screen flex justify-center  container">
      {/* Container */}
      <div className="flex float-cent">
      ...
      <div className="flex justify-center">
        <img className="object-cover" src={Avatar} alt="Photo Thai Duy" />
      </div>
    </div>
  );
};
