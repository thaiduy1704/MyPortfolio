...
const Home = () => {
  return (
    <div className=" bg-[#0a192f] w-full h-screen flex justify-center  ">
      {/* Container */}
      <div className="container mx-auto grid grid-col">
      ...
      <div className="flex justify-center">
        <img className="object-fit" src={Avatar} alt="Photo Thai Duy" />
      </div>
    </div>
  );
};
