...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
      ...
      {/* Hamburger */}
      <div onClick={handleClick} className="md:hidden z-[1000] cursor-pointer">
      ...
      <ul
        className={
          !isNavOpen
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen z-[1000] bg-[#0a192f] flex flex-col justify-center items-center"
        }
      >
