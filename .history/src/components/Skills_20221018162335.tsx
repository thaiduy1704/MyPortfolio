    ...
    <div className="w-full h-screen bg-[#0a192f] text-gray-300 ">
      ...
      <div className="max-w-[1000px] flex flex-col mx-auto">
        ...
        <div className=" grid grid-cols-2 sm:grid-cols-4 gap-1 w-[60%] mx-auto">
          <div className="cursor-pointer   hover:grayscale-0 hover:scale-[100%] duration-300">
            <img className="w-20 mx-auto" src={HTML} alt="" />
            <p className="text-center">HTML</p>
          </div>
          <div className="cursor-pointer   grayscale hover:grayscale-0 hover:scale-[100%] duration-300">
