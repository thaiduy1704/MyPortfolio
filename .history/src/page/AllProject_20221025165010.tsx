      ...
      <div className="bgProject   bg-cover bg-center bg-no-repeat h-[30rem] w-full">
        <div className="container mx-auto my-auto">
          ...
          <div className="text-center pt-[10rem] ">
            ...
            <button className="bg-gray-400 rounded-2xl shadow-gray-500 shadow-2xl hover:shadow-lg hover:shadow-gray-800 hover:bg-gray-400 hover:border-gray-600 p-2 duration-300">
